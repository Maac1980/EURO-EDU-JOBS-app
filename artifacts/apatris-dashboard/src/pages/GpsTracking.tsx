  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 text-center">
          <div className="text-3xl font-black text-lime-300">{anomalies.length}</div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {active.length === 0 ? (
            ...
            <div key={c.id} className={`bg-slate-800/50 rounded-xl p-4 border ${c.is_anomaly ? "border-lime-400/30" : "border-slate-700/50"} flex items-center gap-3`}>
              <div className={`w-3 h-3 rounded-full ${c.is_anomaly ? "bg-lime-400" : "bg-emerald-500"} animate-pulse`} />
              <div className="flex-1">
                ...
                {c.is_anomaly && <div className="text-xs text-lime-300 mt-0.5">{t("gpsTracking.warning")}: {c.anomaly_reason}</div>}
              </div>
        ...
        <div className="space-y-3">
          {anomalies.length === 0 ? (
            ...
            <div key={a.id} className="bg-slate-800/50 rounded-xl p-4 border border-lime-400/20">
              <div className="flex items-center gap-2">
                <AlertTriangle className="w-4 h-4 text-lime-300" />
              ...
              <div className="text-xs text-lime-300/80 mt-1">{a.anomaly_reason}</div>
