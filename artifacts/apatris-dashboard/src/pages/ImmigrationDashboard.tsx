...
const ZONE_STYLES: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  red:     { bg: "bg-lime-400/10",     text: "text-lime-300",     dot: "bg-red-400",     label: "RED" },
  expired: { bg: "bg-lime-400/20",     text: "text-red-300",     dot: "bg-lime-500",     label: "EXPIRED" },
    ...
    <div className="p-6 min-h-screen overflow-y-auto pb-20 bg-background">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          <Stamp className="w-7 h-7 text-[#E9FF70]" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
        {[
          ...
          { label: "RED (<30d)", value: summary.red, color: "text-lime-300", bg: "bg-lime-400/10 border border-lime-400/20" },
          { label: "EXPIRED", value: summary.expired, color: "text-red-300", bg: "bg-lime-400/20 border border-red-800/30" },
        ].map(c => (
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-[#E9FF70]"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-[#E9FF70]"
          >
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-20">
          <div className="animate-spin w-8 h-8 border-2 border-[#E9FF70] border-t-transparent rounded-full" />
        </div>
      ) : filtered.length === 0 ? (
                    ...
                    <td className="px-4 py-3">
                      {p.days !== null ? (
                        <span className={`font-bold font-mono ${
                          ...
                          p.zone === "red" || p.zone === "expired" ? "text-lime-300" :
                          "text-slate-400"
                        }`}>
            ...
            <div className="p-6 space-y-4">
              {historyLoading ? (
                <div className="flex justify-center py-10">
                  <div className="animate-spin w-6 h-6 border-2 border-[#E9FF70] border-t-transparent rounded-full" />
                </div>
