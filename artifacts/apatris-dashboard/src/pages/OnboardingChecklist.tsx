...
export default function OnboardingChecklist() {
  ...
  const config = PAGE_CONFIG["OnboardingChecklist"];
  ...
  return (
    <div className="p-6 min-h-screen overflow-y-auto pb-20 bg-background">
      <h1 className="text-2xl font-bold text-white flex items-center gap-2 mb-6">
        <Icon className="w-6 h-6 text-primary" /> {config?.title ?? "OnboardingChecklist"}
      </h1>

      {"OnboardingChecklist" === "AiCopilotChat" ? (
      ...
      ) : "OnboardingChecklist" === "CrmPipeline" ? (
      ...
      ) : "OnboardingChecklist" === "GeofenceMap" ? (
        <div className="bg-card border border-border rounded-xl p-5">
