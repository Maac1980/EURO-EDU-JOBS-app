      ...
      <div className="relative w-full max-w-lg bg-slate-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 border-b border-white/10 bg-gradient-to-r from-red-900/20 to-transparent">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-lime-500/20 border border-lime-400/30 flex items-center justify-center">
        ...
        <div className="p-5">
          {status === "idle" || status === "error" ? (
            <>
              ...
              <div className="mb-4 p-3 rounded-xl bg-slate-800 border border-slate-700 space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-slate-900 border border-slate-600 text-white rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:border-lime-400/60"
                >
              ...
              {status === "error" && (
                <div className="mb-4 p-3 rounded-lg bg-lime-400/30 border border-lime-400/30 text-red-300 text-sm font-mono">
                  {errorMsg}
                </div>
              )}
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                  totalFiles === 0
                    ...
                    : "bg-lime-500 hover:bg-lime-500 text-white shadow-[0_0_20px_rgba(220,38,38,0.4)]"
                }`}
              >
            ...
            <div className="py-12 flex flex-col items-center gap-4">
              <Loader2 className="w-12 h-12 text-lime-300 animate-spin" />
